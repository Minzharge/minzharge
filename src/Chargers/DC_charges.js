...
function DCcharges()
{
  ...
  const [pricehide, setPricehide] = useState('15kW')
...
const [features, setFeatures] = useState(false)
  ...
  const [spechide, setSpechide] = useState('15kW');
  const table_data = [{
        name: "Kasa (48V/24AH)",
        price: "₹ 68,500",
...
return (
  <div className='w-full'>
    ...
    <div className={expand ? 'hidden': 'p-2'}>
      ...
      <div className='md:p-5 text-center md:text-left'>
          <h1 className='text-3xl'>DC Chargers
</h1>
  ...
  <div className='my-10'>
      <h3 className='font-sans text-xl mb-8 font-bold'>About DC Chargers</h3>
      <p className={clamp ? "line-clamp-none" : "line-clamp-5"}>
      Plugzmart DC fast charger is the perfect balance of size and power, compact enough to fit within most parking layouts, yet providing exceptional reliability and power output. Its modular design allows for easy maintenance and seamless scalability.
       With up to 2 connectors, Plugzmart fast charger is compatible with most electric vehicles.
      </p>
      ...
      spechide === '60kW' &&(
          ...
          <div className='w-full md:w-[80%] mx-auto my-10'>
              ...
              <table className='table-auto'>
                  ...
                  <tr className='w-full'>
                          <td className='w-3/6'>Battery Charging time</td>
                          <td className='w-3/6 text-right'>4 Hrs</td>
                      </tr>
                      <tr className='w-full'>
                          <td className='w-3/6'>Fast Charging Time</td>
                          <td className='w-3/6 text-right'>--</td>
