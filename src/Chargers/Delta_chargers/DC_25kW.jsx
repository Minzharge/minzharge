      ...
      <div className={expand ? 'hidden': 'p-2'}>
       <ProductCarousal/>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl font-black'>Delta DC Wallbox EV Charger</h1>
      ...
      spechide === '3.3kW' &&(
          ...
          <div className='w-full md:w-[80%] mx-auto my-10'>
              ...
              <table className='table-auto md:mx-10 xs:mx-5 antialiased ' >
                  <tbody>
                      <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black'>380~415 Vac; 50 / 60Hz; Three-phase / L1, L2, L3, N, PE</td>
                      </tr>
                      ...
                      <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black'>&gt;0.98
</td>

                      </tr>
                      <tr className='w-full'>
                          <td className='w-3/6 text-gray-600'>Current THD 

</td>
                          <td className='w-3/6 text-right font-black'>Compliant with IEC 61000-3-12</td>
                      </tr>
              ...
              <table className='table-auto md:mx-1 xs:mx-5 antialiased'>
                  <tbody>
                  <tr className='w-full'>
                          <td className='w-3/6 text-gray-600'>Efficiency 

</td>
                          <td className='w-3/6 text-right font-black'>92%</td>
                      </tr>
                      <tr className='w-full'>
                          <td className='w-3/6 text-gray-600'>DC Output #1*
 
</td>
                          <td className='w-3/6 text-right font-black'> IEC CCS Combo 2, 200-500 Vdc, 60A max.,25kW max.(Optional: SAE DC)</td>
                      </tr>
