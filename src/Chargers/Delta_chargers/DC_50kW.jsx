      ...
      <div className={warranty ? 'grid md:grid-cols-2 overflow-none' : 'grid md:grid-cols-2 w-full h-[100px] overflow-hidden tracking-wide'}>
        ...
        <table className='table-auto md:mx-1 xs:mx-5'>
                  ...
                  <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right'>OTP/RFID based </td>
                      </tr>
                  <tr className='w-full'>
      ...
      <div className={warranty ? 'grid md:grid-cols-2 overflow-none' : 'grid md:grid-cols-2 w-full h-[100px] overflow-hidden tracking-wide'}>
        ...
        <table className='table-auto md:mx-1 xs:mx-5'>
                  ...
                  <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right'>5mtr. standard
</td>
                      </tr>
                      <tr className='w-full'>
                          <td className='w-3/6'>Dimension (HxWxD)  
</td>
                          <td className='w-3/6 text-right'>1900mm x 750mm x 500mm
                      ...
                      <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right'>~350Kg
