      ...
      <div className={expand ? 'hidden': 'p-2'}>
       <ProductCarousal/>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl font-black'>DC City Charger 50KW </h1>
          ...
          <div className='w-full md:w-[80%] mx-auto my-10'>
              ...
              <table className='table-auto md:mx-10 xs:mx-5 antialiased ' >
                  <tbody>
                      ...
                      <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black'>&ge;0.99
</td>
                      ...
                      <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black'>&ge;94%</td>
                      </tr>
                      ...
                      <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black'>2Nos</td>
                      </tr>      
                  </tbody>
               </table>
              <table className='table-auto md:mx-1 xs:mx-5 antialiased'>
                  <tbody>
                      ...
                      <tr className='w-full'>
                          <td className='w-3/6 text-gray-600'>Output Power 
 
</td>
                          <td className='w-3/6 text-right font-black'>50kW Max.</td>
                      </tr>
                      <tr className='w-full'>
                          <td className='w-3/6 text-gray-600'>Connectors


</td>
                          <td className='w-3/6 text-right font-black'>CCS Type 2</td>
                      </tr>
                      <tr className='w-full'>
                          <td className='w-3/6 text-gray-600'>Output Voltage


</td>
                          <td className='w-3/6 text-right font-black'>300-750VDC </td>
                      </tr>
                      <tr className='w-full'>
                          <td className='w-3/6 text-gray-600'>Output Current 

</td>
                          <td className='w-3/6 text-right font-black'>125A Max.</td>
                      </tr>
      ...
      <div className={warranty ? 'grid md:grid-cols-2 overflow-none' : 'grid md:grid-cols-2 w-full h-[100px] overflow-hidden tracking-wide'}>
              <table className='table-auto md:mx-10 xs:mx-5' >
                  <tbody>
                      ...
                      <tr className='w-full'>
                          <td className='w-3/6'>Language</td>
        ...
        <table className='table-auto md:mx-1 xs:mx-5'>
                  ...
                  <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black '>OTP/RFID based </td>
                      </tr>
                  <tr className='w-full'>
...
Interface : Ethernet, 3G/4G
      ...
      <div className={warranty ? 'grid md:grid-cols-2 overflow-none' : 'grid md:grid-cols-2 w-full h-[100px] overflow-hidden tracking-wide'}>
        ...
        <table className='table-auto md:mx-1 xs:mx-5'>
                  <tbody>
                  <tr className='w-full'>
                          <td className='w-3/6'>Wire length
</td> 
                          <td className='w-3/6 text-right font-black '>5mtr. standard
</td>
                      </tr>
                      <tr className='w-full'>
                          <td className='w-3/6'>Dimension (HxWxD)  
</td>
                          <td className='w-3/6 text-right font-black '>1900mm x 750mm x 500mm

                          </td>
                      </tr>                   
                      <tr className='w-full'>
                          <td className='w-3/6'>Weight 
</td>
                          <td className='w-3/6 text-right font-black '>~350Kg
