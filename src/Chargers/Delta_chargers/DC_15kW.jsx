    ...
    <div className={expand ? 'hidden': 'p-2'}>
     <ProductCarousal/>
      ...
      <div className='md:p-5 text-center md:text-left'>
          <h1 className='text-3xl font-black'>Bharat Charger(BEVC-DC001)
</h1>
          ...
          <div className="py-2 w-layout-grid specifications-grid">
                          ...
                          <div className="specification-container"><img src={assetUrl + "/Key_highlights_icon/Reverse Mode.png"} class="car-icons"/>
                              <div>
                                  <div> Wired/ wireless connectivity for integration</div>                                                                </div>
                          </div>
          ...
          <div className='w-full md:w-[80%] mx-auto my-10'>
              ...
              <table className='table-auto md:mx-1 xs:mx-5 antialiased'>
                  ...
                  <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black'>1 Nos.</td>
                      </tr>
                      <tr className='w-full'>
              ...
              <table className='table-auto md:mx-10 xs:mx-5' >
                  <tbody>
                      <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black'> 7” TFT LCD with Touch</td>
                      </tr>
                      <tr className='w-full'>
        ...
        <table className='table-auto md:mx-1 xs:mx-5'>
                  ...
                  <tr className='w-full'>
                      ...
                      <tr className='w-full'>
                          ...
                          <td className='w-3/6 text-right font-black'>650 mm X 1600 mm X 395 mm
                          </td>
                      </tr>                   
          </tbody>
               </table>
