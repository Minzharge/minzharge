 ...
 const updatedField = (e) =>{
  ...
  return (
    <>
      ...
      <section class="flex relative flex-col   mt-16 leading-6 text-black lg:flex-row ">
     
        <div className="form-group col-md-6 relative px-4 pr-4 md:pl-8 lg:pl-12 min-[320px]:pl-4 leading-4  w-full">
          <select name="select"  value={inputs.select} onChange={updatedField} className="select leading-4 border-b-2 block w-full pt-1 pr-3  bg-white rounded-none" type="drop-down" style={{}}>
          ...
          <input type="text" className=" w-full border-b-2 block w-full pt-1 pr-3 text-lg 
          bg-white rounded-none leading-[4rem]  focus:border-b-2 " name="first_name" value={inputs.first_name} onChange={updatedField} placeholder="*First name" id="inputName" />
          ...
          <input type="text" className="  w-full border-b-2 block w-full pt-1 pr-3 text-lg bg-white rounded-none leading-[4rem] focus:border-none" name="phone" value={inputs.phone} onChange={updatedField} placeholder="*Phone" id="inputNumber" />
        ...
        >
          <div className="form-group col-md-6 relative ">
            ...
            <textarea className="form-control1  w-full leading-[2.5rem] border-2 pt-1 pr-3 text-lg
             bg-white rounded-none  focus:border-none" rows={5} name="text_message" value={inputs.text_message} onChange={updatedField} placeholder="*how can we help you?" id="inputMessage" defaultValue={""} />
            <label htmlFor="inputNumber" />
