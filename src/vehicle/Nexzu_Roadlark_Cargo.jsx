...
function Nexzu_Roadlark_Cargo() {
    ...
    const table_data = [{
          name: "Roadlark Cargo (42V/2AH)",
          price: "₹ 48,789 ",
          onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "85 Km, 25 Kmph, 3 Hrs"
      }
  ];
    ...
    <div className='w-full'>
      ...
      <div className={expand ? 'hidden': 'p-2'}>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl'>Nexzu Roadlark - Cargo </h1>
			<h1 className='py-2 text-lg text-gray-500'>Electric Cargo Cyle carry upto 100 kgs</h1>
		  <hr className='mb-5'/>
             ...
             <div className="w-layout-grid specifications-grid">
                        ...
                        pricehide === 'lead' && (
                            <div className='flex pb-7 justify-center md:justify-start sm:mt-5'>
                                <h1 className='text-3xl text-[#40b322] font-[600]'>₹ 48,789</h1>
            ...
            <div className='w-full md:w-[80%] mx-auto my-10'>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right text-black'>Lithium -Ion 36 V, Front 5.2 AH & Rear 8.7 AH</td>
                        </tr>
					
                        <tr className='w-full'>
                            <td className='w-3/6'>Motor</td>
                            <td className='w-3/6 text-right'>BLDC Motor 250 W 36 V</td>

                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Battery Location</td>
                            <td className='w-3/6 text-right'>In Frame + Rear (Detachable)</td>
                        </tr>
                        <tr className='w-full'>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>"Front 2.5 Hrs - 3 Hrs,Rear 4.5 Hrs - 5 Hrs"</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Battery Cell Life</td>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>65 Km</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Cargo</td>
                            <td className='w-3/6 text-right'> Available</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Frame Material</td>
                            <td className='w-3/6 text-right'>Colled Rolled Steel</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Brakes</td>
                            <td className='w-3/6 text-right'>Dual Disc Electric</td>
                        </tr>
                        <tr className='w-full'>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>Steel fork suspension</td>
                        </tr>
                ...
                <table className='table-auto md:mx-1 xs:mx-5'>
                    <tbody>
                        ...
                        <tr className='w-full'>
                            <td className='w-3/6'>Head Lamp</td>
                        ...
                        <tr className='w-full'>
                            <td className='w-3/6'>Auto electric cut off on braking</td>
                            <td className='w-3/6 text-right'>Yes</td>
                        </tr>
                          <tr className='w-full'>
                          ...
                          <tr className='w-full'>
                            <td className='w-3/6'>Auto electric cut</td>
                            <td className='w-3/6 text-right'>Yes</td>
                        </tr>
                          <tr className='w-full'>
                            <td className='w-3/6'>Weight</td>
                            <td className='w-3/6 text-right'>27 kg</td>
                        </tr>
                          <tr className='w-full'>
                            <td className='w-3/6'>Dimensions</td>
                            <td className='w-3/6 text-right'>73.4 × 25 × 40 in</td>
                        </tr>
                          <tr className='w-full'>
                            <td className='w-3/6'>Color</td>
                            <td className='w-3/6 text-right'>Blue, Red, Silver, Black</td>
                        </tr>
                         <tr className='w-full'>
                            <td className='w-3/6'>Drivetrain</td>
                            <td className='w-3/6 text-right'>Rear 18T front 44T</td>
                        </tr>
                         <tr className='w-full'>
                          ...
                          <tr className='w-full'>
                            <td className='w-3/6'>Payload</td>
                            <td className='w-3/6 text-right'>Total (80Kg rider + 15 Kgs Cargo)</td>
                        </tr>
            ...
            <div className='w-full md:w-[80%] mx-auto my-10'>
                ...
                <table className='table-auto md:mx-1 xs:mx-5'>
                    <tbody>
                        ...
                        <tr className='w-full'>
                            <td className='w-3/6'>Motor 36V 250W</td>
                            <td className='w-3/6 text-right'>18 Months</td>
                        </tr>
                        <tr className='w-full'>
...
export default Nexzu_Roadlark_Cargo