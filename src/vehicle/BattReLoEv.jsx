            ...
            <div className='w-full md:w-[80%] mx-auto my-10'>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>Dual disc Brake</td>
                        </tr>
                        <tr className='w-full'>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>Disk</td>
                        </tr>
                        <tr className='w-full'>
                ...
                <table className='table-auto md:mx-1 xs:mx-5'>
                    <tbody>
                        ...
                        <tr>
                            <td>F-Tyre size</td>
                            <td className='w-3/6 text-right'>3.0-10 Tubeless</td>
                        </tr>
                        <tr>
                            <td>R-Tyre size</td>
                            <td className='w-3/6 text-right'>3.0-10 Tubeless</td>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>60 Kgs</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Length</td>
                            <td className='w-3/6 text-right'>1820 mm</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Width</td>
                            <td className='w-3/6 text-right'>520 mm</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Height</td>
                            <td className='w-3/6 text-right'>1120 mm</td>
                        </tr>
						 </tbody>
                 </table>
				  <table className='table-auto md:mx-1 xs:mx-5'>
        ...
        <div className='w-full md:w-[80%] mx-auto my-10'>
            ...
            <table className='table-auto md:mx-10 xs:mx-5' >
                <tbody>
                        ...
                        <tr className='w-full'>
                            <td className='w-3/6'>Battery Capacity</td>
                            <td className='w-3/6 text-right'>60V/28AH</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Batter IP Rating</td>
                            <td className='w-3/6 text-right'>--</td>
        ...
        <div className='w-full md:w-[80%] mx-auto my-10'>
            ...
            <table className='table-auto md:mx-10 xs:mx-5' >
              ...
              <table className='table-auto md:mx-1 xs:mx-5'>
                <tbody>
                    <tr className='w-full'>
                        <td className='w-3/6'>Battery Waranty</td>
                        <td className='w-3/6 text-right'>3 Yrs</td>
                    </tr>                        
                    </tbody>
             </table>
