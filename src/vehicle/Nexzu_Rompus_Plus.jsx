    ...
    <div className='w-full'>
      ...
      <div className={expand ? 'hidden': 'p-2'}>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl'>Nexzu Rompus +</h1>
		  ...
		  <hr className='mb-5'/>
            <div className='mt-5 mb-5'>
                ...
                <select name="" id="type" className='w-[200px] p-3 border-b-2 border-black outline-none' onChange={handlePriceHide}>
                    ...
                    <option value="lead">37 Km</option>
                      </select>
            </div>
             <div className="w-layout-grid specifications-grid">
                        ...
                        pricehide === 'lead' && (
                            <div className='flex pb-7 justify-center md:justify-start sm:mt-5'>
                                <h1 className='text-3xl text-[#40b322] font-[600]'>₹ 33,981</h1>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right text-black'>Li -ion 5.2 AH</td>
                        </tr>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>In Frame</td>
                        </tr>
                        <tr className='w-full'>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>2.5 Hrs - 3 Hrs</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Battery Cell Life</td>
                            <td className='w-3/6 text-right'>1000 Life Cycles</td>
                        </tr>
                       
                        <tr className='w-full'>
                            <td className='w-3/6'>Pedelec Mode</td>
                            <td className='w-3/6 text-right'>37 Km</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Throttle Mode</td>
                            <td className='w-3/6 text-right'>33 Km</td>
                        </tr>
                        <tr className='w-full'>
                          ...
                          <tr className='w-full'>
                            <td className='w-3/6'>Seat</td>
                            <td className='w-3/6 text-right'>Comfy Cusion</td>
                        </tr>
                          <tr className='w-full'>
...
export default Nexzu_Rompus_Plus