...
function ProductCarousal() {
  let temp = 0;
  const images = [
    "https://5.imimg.com/data5/SELLER/Default/2021/7/UM/WP/ZA/128817549/2-500x500.jpg",
    "https://5.imimg.com/data5/SELLER/Default/2021/7/BH/YE/NG/128817549/5-500x500.jpg",
    "https://5.imimg.com/data5/SELLER/Default/2021/7/BR/CY/SM/128817549/4-500x500.jpg",
    "https://5.imimg.com/data5/SELLER/Default/2021/7/JO/YX/HQ/128817549/3-500x500.jpg",
    "https://5.imimg.com/data5/SELLER/Default/2021/7/ZL/RF/GF/128817549/dexpress-mettle-electric-scooter-500x500.jpg"
  ];
...
function Dexpress_Mettle() {
    ...
    const table_data = [
      {
          name: "Dexpress Mettle - (60 V / 30AH)",
          price: "₹ 1,04,000",
          onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "85 Km, 25 Kmph, 59.6 kg, 6.5 Hrs"
      },
  ];
    ...
    <div className='w-full'>
      ...
      <div className={expand ? 'hidden': 'p-2'}>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl'>Dexpress Mettle</h1>
             ...
             <div className="w-layout-grid specifications-grid">
                        ...
                        pricehide === 'lead' && (
                            <div className='flex pb-7 justify-center md:justify-start sm:mt-5'>
                                <h1 className='text-3xl text-[#40b322] font-[600]'>₹ 1,04,000</h1>
                    ...
                    <tbody>
                        <tr>
                            <td>Battery Charging time</td>
                             <td className='w-3/6 text-right'>3-4 Hrs</td>
                        </tr>
                        <tr>
...
export default Dexpress_Mettle