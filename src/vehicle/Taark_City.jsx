...
function Taark_City() {
    ...
    const table_data = [{
          name: "Taark City (Lead Acid)",
          price: "₹ 1,73,980",
          onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "70 Km, 30 Kmph, 400 Kgs, 7 Hrs"
      },
      {
          name: "Taark City - (Lithium Ferro-phosphate)",
          price: "₹ 2,25,982",
          onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "70 Km, 30 Kmph, 400 Kgs, 7 Hrs"
    ...
    <div className='w-full'>
      ...
      <div className={expand ? 'hidden': 'p-2'}>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl'>Taark City</h1>
		  ...
		  <hr className='mb-5'/>
            <div className='mt-5 mb-5'>
                ...
                <select name="" id="type" className='w-[200px] p-3 border-b-2 border-black outline-none' onChange={handlePriceHide}>
                    ...
                    <option value="lead">Taark City</option>
              ...
              <div className="w-layout-grid specifications-grid">
                            ...
                            <div className="specification-container" ><img src={assetUrl + "/Key_highlights_icon/trolley-push-cart-with-boxes-svgrepo-com.svg"}class="car-icons"/>
                                <div>
                                    ...
                                    <div style={{'textAlign':'left'}}>400 Kgs</div>
                                </div>
                            </div>
                        ...
                        pricehide === 'lead' && (
                            <div className='flex pb-7 justify-center md:justify-start sm:mt-5'>
                                <h1 className='text-3xl text-[#40b322] font-[600]'>₹ 1,73,980</h1>
...

                    {
                        pricehide === 'lithium' && (
                            <div className='flex pb-7 flex pb-7 justify-center md:justify-start sm:mt-5'>
                                <h1 className='text-3xl text-[#40b322] font-[600]'>₹ 2,25,982</h1>
                                <p className='ml-4 mt-4 text-xs' >[Avg Ex-showroom price]</p>
                            </div>
                        )}						
            <hr className='mb-5'/>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>1200W, Brushless (BLDC)</td>

                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Top Speed</td>
                            <td className='w-3/6 text-right'>30 Kmph</td>
                        </tr>
                        <tr className='w-full'>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>400 Kg</td>
                        </tr>
                        <tr className='w-full'>
                ...
                <table className='table-auto md:mx-1 xs:mx-5'>
                    <tbody>
						...
						<tr>
                            ...
                            <td className='w-3/6 text-right'>400 Kgs</td>
                        </tr>
                        <tr>
                            <td>Max Power</td>
                            <td className='w-3/6 text-right'>--</td>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>180 mm</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Brake oil</td>
                            <td className='w-3/6 text-right'>Dot 3 (200 ML)</td>
                        </tr>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>Rigid Axle 33 Inches</td>
                        </tr>
                        <tr className='w-full'>
						...
						<tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>1981 mm</td>
                        </tr>
						<tr className='w-full'>
				  ...
				  <table className='table-auto md:mx-1 xs:mx-5'>
                    <tbody>
                        ...
                        <tr>
                            <td>Front fork</td>
                            <td className='w-3/6 text-right'>Auto type - Single Suspension</td>
                        </tr>
						<tr>
                            <td>Rear Leaf spring</td>
                            <td className='w-3/6 text-right'>45x5 - 5 Plates rigid with helical spring</td>
                        </tr>
						<tr>
                            <td>Rear tire</td>
                            <td className='w-3/6 text-right'>3.75 x 12- 8 PR</td>
                        </tr>
						<tr>
                            <td>Front Tyre</td>
                            <td className='w-3/6 text-right'>3.75 x 12- 8 PR7</td>
                        </tr>
						</tbody>
                 </table>
                </div>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
				  ...
				  <table className='table-auto md:mx-1 xs:mx-5'>
                    <tbody>
						...
						<tr>
                            <td>Rear Leaf spring</td>
                            <td className='w-3/6 text-right'>45x5 - 5 Plates rigid</td>
                        </tr>
						<tr>
                            <td>Rear tire</td>
                            <td className='w-3/6 text-right'>3.75 x 12- 8 PR</td>
