...
function Nexzu_Roadlark() {
    ...
    const table_data = [{
          name: "Nexzu Roadlark (42V/2AH)",
          price: "₹ 45,685 ",
          onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "100 Kms, 25 Kmph, 3 Hrs"
      }
       ];
    ...
    <div className='w-full'>
      ...
      <div className={expand ? 'hidden': 'p-2'}>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl'>Nexzu Roadlark </h1>
            ...
            <div className="w-layout-grid specifications-grid">
                            ...
                            <div className="specification-container" ><img src={assetUrl + "/Key_highlights_icon/tyre.png"}class="car-icons"/>
                                <div>
                                    ...
                                    <div style={{'textAlign':'left'}}>26" Cotton Tube Tyers</div>
                                </div>
                            </div>
                        ...
                        pricehide === 'lead' && (
                            <div className='flex pb-7 justify-center md:justify-start sm:mt-5'>
                                <h1 className='text-3xl text-[#40b322] font-[600]'>₹ 45,685</h1>
    ...
    <div className='flex justify-between my-10 flex-wrap'>
        ...
        <div className=''>
            ...
            <select name="" id="type" className='w-[200px] p-3 border-b-2 border-black outline-none' onChange={handleshowhide}>
                <option value="" disabled>100 Km</option>
            </select>
        </div>
    </div>
    {
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>3-4 Hr</td>
                        </tr>
                        <tr className='w-full'>
                        ...
                        <tr className='w-full'>
                            <td className='w-3/6'>Driver Mode</td>
                            <td className='w-3/6 text-right'>Dual Mode</td>
                        </tr>
                        <tr className='w-full'>
                    ...
                    <tbody>
                        ...
                        <tr className='w-full'>
                          ...
                          <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>23 kg</td>
                        </tr>
                          <tr className='w-full'>
                            <td className='w-3/6'>Dimensions</td>
                            <td className='w-3/6 text-right'>70.4 × 25 × 40 in</td>
                        </tr>
                          <tr className='w-full'>
