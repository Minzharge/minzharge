...
function ProductCarousal () {
  let temp = 0;
  const images = [
    "https://5.imimg.com/data5/SELLER/Default/2021/12/RZ/XO/RO/37904749/semzy-kasa-electric-scooty-500x500.jpg"
  ];
    ...
    <div className='w-full'>
      ...
      <div className={expand ? 'hidden': 'p-2'}>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl'>Semzy Kasa</h1>
