...
function Nexzu_Roadlark_Cargo() {
    ...
    const table_data = [{
          name: "Bazinga Cargo (42V/2AH)",
          price: "₹ 51,525",
		  onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "85 Km, 25 Kmph, 6.5 Hrs"
      }
  ...
  return (
		  ...
		  <hr className='mb-5'/>
            <div className='mt-5 mb-5'>
               ...
               <select name="" id="type" className='w-[200px] p-3 border-b-2 border-black-900 outline-none' onChange={handlePriceHide}>
                    ...
                    <option value="lead">100 Km</option></select>
            </div>
             <div className="w-layout-grid specifications-grid">
                        ...
                        pricehide === 'lead' && (
                            <div className='flex pb-7 justify-center md:justify-start sm:mt-5'>
                                <h1 className='text-3xl text-[#40b322] font-[600]'>₹ 51,525</h1>
    ...
    <div className='my-10'>
        <h3 className='font-sans text-xl mb-8 font-bold'>About Nexzu Bazinga Cargo</h3>
    ...
    </div>
    {
        spechide === 'lead' &&(
            ...
            <div className='w-full md:w-[80%] mx-auto my-10'>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right text-black'>Li -ion 36 V, Front 14.5 AH</td>
                        </tr>
					
                        <tr className='w-full'>
                            <td className='w-3/6'>Motor</td>
                            <td className='w-3/6 text-right'>36 Volt/250 Watt BLDC Motor</td>

                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Battery Location</td>
                            <td className='w-3/6 text-right'>Rear Detachable</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Charging Time</td>
                            <td className='w-3/6 text-right'>6.5 - 7 Hours</td>
                        </tr>
                        <tr className='w-full'>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>61 Km</td>
                        </tr>
                        <tr className='w-full'>
                        ...
                        <tr className='w-full'>
                            <td className='w-3/6'>Motor</td>
                            <td className='w-3/6 text-right'>BLDC 250W 36V</td>
                        </tr>
                        <tr className='w-full'>
                ...
                <table className='table-auto'>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>Auto electric cut off on braking</td>
                            <td className='w-3/6 text-right'>Yes</td>
                        </tr>
						<tr >
                            <td>Weight</td>
						...
						<tr >
                            <td>Color</td>
                            <td className='w-3/6 text-right'>Red, Black</td>
                        </tr>
						<tr >
                            <td>Payload</td>
            ...
            <div className='w-full md:w-[80%] mx-auto my-10'>
                <div className='flex'>
                    <h6 className='text-xl font-semibold  '>Warrenty</h6>
                </div>
