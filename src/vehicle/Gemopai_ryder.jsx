...
function ProductCarousal () {
  let temp = 0;
  const images = [
    "https://5.imimg.com/data5/SELLER/Default/2022/4/IW/IW/MK/15110603/gemopai-ryder-high-speed-electric-scooter-500x500.jpg",
    "https://5.imimg.com/data5/SELLER/Default/2022/4/YP/KR/JF/15110603/gemopai-ryder-high-speed-electric-scooter-500x500.JPG",
    "https://5.imimg.com/data5/SELLER/Default/2022/4/PI/RY/AH/15110603/gemopai-ryder-high-speed-electric-scooter-500x500.png",
    "https://5.imimg.com/data5/SELLER/Default/2022/4/PN/LT/MU/15110603/gemopai-ryder-high-speed-electric-scooter-500x500.jpg",
	"https://5.imimg.com/data5/SELLER/Default/2022/4/AS/TF/HH/15110603/gemopai-ryder-high-speed-electric-scooter-500x500.JPG"
  ];
...
function Gemopai_ryder() {
    ...
    const table_data = [{
          name: "Gemopai Ryder (48V / 26 H)",
          price: "₹ 76,500",
          onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "55 Km, 25 Kmph, 80 kg, 5 Hrs"
      },
      {
          name: "Gemopai Ryder (48V / 30AH)",
          price: "₹81,700",
          onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "65 Km, 25 Kmph, 80 kg, 5 Hrs"
      },
        {
          name: "Gemopai Ryder (48V / 40 AH)",
          price: "₹90,700",
          onRoad: "(Avg. Ex-Showroom price)",
          offerLink: '#',
          kms: "90 Km, 25 Kmph, 80 kg, 5 Hrs"
      },
  ];
    ...
    <div className='w-full'>
      ...
      <div className={expand ? 'hidden': 'p-2'}>
        ...
        <div className='md:p-5 text-center md:text-left'>
            <h1 className='text-3xl'>Gemopai Ryder</h1>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>250W DC Brushless Motors</td>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>55 Km</td>
                        </tr>
                        <tr className='w-full'>
                    ...
                    <tbody>
                        <tr>
                            <td>Battery Charging time</td>
                             <td className='w-3/6 text-right'>4-5 hrs</td>
                        </tr>
                        <tr>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        ...
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>650 mm</td>
                        </tr>
                        <tr className='w-full'>
				  ...
				  <table className='table-auto md:mx-1 xs:mx-5'>
                    <tbody>
                        <tr>
                            ...
                            <td className='w-3/6 text-right'>160 mm</td>
                        </tr>
                        <tr>
                            <td>Wheelbase</td>
                            <td className='w-3/6 text-right'>--</td>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                    <tbody>
                        <tr className='w-full'>
                            ...
                            <td className='w-3/6 text-right'>1.5 Yrs</td>
                        </tr>
                        	</tbody>
                 </table>
				  <table className='table-auto md:mx-1 xs:mx-5'>
                ...
                <table className='table-auto md:mx-1 xs:mx-5'>
                    <tbody>
						...
						<tr>
                            ...
                            <td className='w-3/6 text-right'>Portable Batter, Long seat with backrest, Digital Speedometer, Anti theft alarm. Keyless entry, USB charging, Alloy wheels and Tubeless tyres</td>
                        </tr>
            ...
            <div className='w-full md:w-[80%] mx-auto my-10'>
                ...
                <table className='table-auto md:mx-10 xs:mx-5' >
                   <tbody>
                        ...
                        <tr className='w-full'>
                            <td className='w-3/6'>Battery Capacity</td>
                            <td className='w-3/6 text-right'>48V/40AH</td>
                        </tr>
                        <tr className='w-full'>
                            <td className='w-3/6'>Batter IP Rating</td>
                            <td className='w-3/6 text-right'>--</td>
